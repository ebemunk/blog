...
// from https://web.archive.org/web/20041022052012/http://www.playboy.com/mediakit/online_demographics.html
const gender = [
...
const medianHouseholdIncome = 57_427
...
export default hot(module)(DemographicsOnline)
